...
#define MAP_SIZE		1025	// Este é o tamanho do arquivo .RAW (tamanho em pixels)
#define STEP_SIZE		5.0f	// Esta é a largura e altura de cada QUAD (quadrado do terreno) (quantos pixels ele vai pegar para formar cada quadrado na renderizãção)
#define	HEIGHT_RATIO	1.0f    // Altura máxima que o Y pode alcançar (1 = 255) (2 = 510)
